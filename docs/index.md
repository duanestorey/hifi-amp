...
- [Build](build.md)
    - [Chassis](build/chassis.md)
    - [IEC Inlet & Transformer](build/iec.md)
    - [Grounds and Ground Lift](build/grounds.md)
    - [Amplifier Back Panel](build/amp-back-panel.md)
    - [Rectifier & Main PSU](build/psu.md)
    - [Accessory PSU](build/dual-psu.md)
    - [FTDI & Microprocessor](build/ftdi-uproc.md)
    - [Buttons & LCD](build/buttons.md)
    - [GPIO Extender](build/gpio.md)
    - [Inputs & Input Selector](build/inputs.md)
    - [Vinyl](build/vinyl.md)
