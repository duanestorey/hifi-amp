...
#define I2C_SLAVE_SCL_IO 6               /*!< gpio number for i2c slave clock */
#define I2C_SLAVE_SDA_IO 7               /*!< gpio number for i2c slave data */
#define I2C_SLAVE_NUM    0
#define ESP_SLAVE_ADDR   0x58           /*!< ESP slave address, you can set any 7bit value */
